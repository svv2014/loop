...
bootstrap_register_launchd() {
    ...
    # Scanner liveness watchdog — checks scanner-heartbeat every 5 min and
    # force-restarts the scanner via launchctl kickstart if the heartbeat is
    # stale. Pairs with the heartbeat write added in scanner.sh.
